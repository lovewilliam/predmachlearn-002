...
This is a typical classification problem. So I will choose some classification model to train.
...
This is the instruction to do barbell lift.
...
Use PCA version on cross-validation data, we got:
...
Sensitivity            0.9986   0.9810   0.9778   0.9614   0.9900
Specificity            0.9969   0.9962   0.9906   0.9980   0.9983
Pos Pred Value         0.9922   0.9841   0.9565   0.9898   0.9922
Neg Pred Value         0.9994   0.9955   0.9953   0.9925   0.9978
Prevalence             0.2845   0.1935   0.1743   0.1639   0.1837
Detection Rate         0.2841   0.1898   0.1705   0.1576   0.1819
Detection Prevalence   0.2863   0.1929   0.1782   0.1593   0.1833
Balanced Accuracy      0.9977   0.9886   0.9842   0.9797   0.9941
> 
```
The accuracy of pca version is slightly lower than non-pca version.
We can infer from the confusionMatrix:
...
without PCA we got this on cross-validation data
```
> confusionMatrix(res,refinedValidation$classe)
Confusion Matrix and Statistics
...
> 
```
We can get the following table from confusionMatrix
...
In summary, the predictor tends to give higher grade on validation data when mis-classification happens. But can also give lower grade.
